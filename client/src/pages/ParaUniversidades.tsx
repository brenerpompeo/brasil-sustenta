...
const institutionalFlow = [
  {
    ...
    description:
      "Definir contato, campus, cursos, objetivos de extensao e formato inicial de ativacao na rede.",
  },
  {
    title: "Ativar talentos e HUB local",
    description:
      "Mapear oferta de alunos, liderancas estudantis, coordenacao e possiveis embaixadores ou professors aliados.",
  },
  {
    title: "Conectar com desafios e evidencias",
    description:
      "Distribuir desafios, acompanhar alocacoes, consolidar horas e relatorios para a instituicao.",
  },
];
...
const hubAssets = [
  {
    ...
    description:
      "Microcelula local para captar talentos, articular campus e dar capilaridade a eventos e desafios.",
  },
  {
    title: "Eventos semestrais",
    description:
      "Challenge sessions, demo days e encontros de discovery para gerar reputacao, talentos e leads.",
  },
  {
    title: "Relatorio institucional",
    description:
      "Consolidacao de horas, participacao, desafios ativos e sinais de empregabilidade em uma mesma camada.",
  },
];
          ...
          <div className="mx-auto grid max-w-[1280px] gap-10 px-6 py-14 sm:px-8 lg:grid-cols-[1.08fr_0.92fr] lg:px-16 lg:py-20">
            ...
            >
              ...
              <p className="mt-8 max-w-2xl border-l-[3px] border-primary pl-5 text-base font-medium leading-8 text-foreground/78 sm:text-[1.05rem]">
                O Brasil Sustenta ajuda a universidade a conectar talentos e
                cursos a desafios ESG de mercado. A tese aqui nao e apenas
                empregabilidade, nem apenas relacionamento institucional: e
                extensao com operacao, evidencia e contexto de negocio.
              </p>
              ...
              <div className="mt-10">
                <Button
                  asChild
                  size="lg"
                  className="h-12 rounded-full px-6 text-sm font-bold uppercase tracking-[0.14em]"
                >
                  <a href="#form">
                    Solicitar parceria
        ...
        <section id="form" className="border-b border-border py-20 lg:py-24">
          <div className="container mx-auto grid max-w-[1200px] gap-8 px-6 lg:grid-cols-[0.8fr_1.2fr] lg:px-8">
            <Card className="rounded-[1.75rem] border-border bg-foreground text-background shadow-sm">
              <CardHeader>
                ...
                <CardTitle className="font-display text-[2rem] leading-[1.05] tracking-tight text-white">
                  A universidade vira mais forte quando entra como parte da
                  operacao, nao so como origem de talentos.
                </CardTitle>
              </CardHeader>
              <CardContent>
                <p className="text-sm font-medium leading-7 text-background/75">
                  A parceria funciona melhor quando a IES deixa claro quais
                  cursos, polos, trilhas e formatos de extensao quer ativar.
                  Isso ajuda a plataforma a distribuir desafios com mais
                  aderencia e a gerar relatorios realmente uteis.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="rounded-[1.75rem] border-border bg-card shadow-sm">
              <CardHeader>
                <CardTitle className="font-display text-[2rem] tracking-tight">
                  Solicitar parceria institucional
                </CardTitle>
                <CardDescription className="text-sm font-medium leading-7 text-muted-foreground">
                  Preencha os dados abaixo para iniciarmos uma conversa sobre
                  extensao, empregabilidade e projetos reais.
                </CardDescription>
              </CardHeader>
                ...
                {partnershipSubmitted ? (
                  <div className="rounded-2xl border border-primary/20 bg-primary/5 p-6">
                    ...
                    <p className="mb-4 text-sm font-medium leading-7 text-foreground/80">
                      Recebemos os dados da sua instituicao. Agora o proximo
                      passo e validar aderencia, formato de parceria e melhor
                      rota de ativacao.
                    </p>
                    <Button
                      variant="outline"
                      onClick={() => setPartnershipSubmitted(false)}
          ...
          <div className="container mx-auto max-w-[1200px] px-6 lg:px-8">
            <div className="mb-12 max-w-3xl">
              ...
              <h2 className="font-display text-[2.2rem] font-bold tracking-tight text-foreground lg:text-[3.2rem]">
                A parceria fica melhor quando a IES entende o processo inteiro,
                nao so o formulario.
              </h2>
            </div>
              ...
              {institutionalFlow.map((step, index) => (
                ...
                >
                  <Card
                    className={
                      index === 1
                        ? "rounded-[1.5rem] border-primary/30 bg-primary/5 shadow-sm hover:shadow-[0_24px_40px_rgba(5,5,5,0.05)]"
          ...
          <div className="container mx-auto max-w-[1200px] px-6 lg:px-8">
            <div className="mb-12 grid gap-6 lg:grid-cols-[0.9fr_1.1fr] lg:items-end">
              <div>
                ...
                <h2 className="font-display text-[2.2rem] font-bold tracking-tight text-foreground lg:text-[3.2rem]">
                  A universidade tambem cresce como ponto de distribuicao da
                  rede.
                </h2>
              </div>
              <p className="text-[15px] font-medium leading-7 text-muted-foreground">
                O papel institucional nao termina na validacao de horas. A IES
                pode operar como supply engine, palco de eventos e base local de
                ativacao para o Brasil Sustenta.
              </p>
            </div>

            <div className="grid gap-6 md:grid-cols-3">
              {hubAssets.map((asset, index) => (
                <motion.div
                  key={asset.title}
                  initial={{ opacity: 0, y: 24 }}
                  whileInView={fadeUpTarget(index * 0.08, 24)}
