...
import {
  Target, Leaf, Heart, MonitorPlay, Users, Droplets, Zap, Briefcase,
  Factory, Scale, Building2, Recycle, CloudRain, Fish, TreePine, Shield, Network, Handshake,
} from 'lucide-react';
        ...
        <div className="mb-16 flex flex-col gap-8 md:flex-row md:items-end md:justify-between">
          ...
          >
            ...
            >
              ...
              <span className="font-light italic text-[--leaf]"> Desenvolvimento Sustentável</span>.
            </h2>
          </motion.div>
          ...
          >
            <p className="border-l-2 border-[--leaf]/30 pl-4 font-sans text-[14px] font-medium leading-relaxed text-[--ink]/40">
              Nossa abordagem potencializa as diretrizes globais de sustentabilidade, conectando talentos a empresas comprometidas com{' '}
              ...
              >
                <div className="absolute inset-0 flex flex-col items-start justify-between p-3">
                  <span
                    ...
                    style={{ color: isHovered ? 'rgba(255,255,255,0.9)' : 'rgba(255,255,255,0.2)' }}
                  >
                  ...
                  <div className="w-full">
                    <div
                      ...
                      style={{ color: isHovered ? 'rgba(255,255,255,0.9)' : ods.color, opacity: isHovered ? 1 : 0.7 }}
                    >
                      <ods.Icon className="h-5 w-5" strokeWidth={isHovered ? 2.5 : 1.5} />
                    </div>
                    <h3
