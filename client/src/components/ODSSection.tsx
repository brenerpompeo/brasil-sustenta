...
const ODSSection = () => {
  ...
  return (
    <section className="py-24 bg-[#F8FAFC] relative overflow-hidden border-y border-paper-3">
      ...
      <div className="container px-6 lg:px-8 max-w-[1200px] mx-auto relative z-10 mb-16">
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-8">
          <div className="max-w-2xl animate-fade-in-up">
            <div className="inline-flex items-center gap-2 px-3 py-1 bg-ink/5 border border-ink/10 rounded-full text-[11px] font-bold tracking-widest uppercase text-ink-2 mb-6">
              <Sparkles className="w-3 h-3 text-leaf-1" />
              Impacto ESG e Agenda 2030
            </div>
            
            <h2 className="font-display text-[2rem] lg:text-[2.75rem] font-black text-ink leading-[1.1]">
              Integração aos Objetivos de <span className="italic font-light text-leaf-1">Desenvolvimento Sustentável</span> da ONU
            </h2>
          </div>
          
          <div className="md:max-w-md animate-fade-in-up" style={{ animationDelay: '100ms' }}>
            <p className="text-[15px] text-ink-3 font-medium leading-relaxed border-l-2 border-leaf-1 pl-4">
              Nossa abordagem potencializa as diretrizes globais de sustentabilidade, conectando jovens talentos a empresas comprometidas com metas de <strong className="text-ink">Valor Compartilhado</strong>.
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="relative w-full overflow-hidden flex items-center py-4 bg-white/50 backdrop-blur shadow-sm">
