      ...
      <div className="grid grid-cols-1 divide-y divide-white/10 border-b border-white/10 md:grid-cols-3 md:divide-x md:divide-y-0">
        {testimonials.map((t, i) => (
          <motion.div
            ...
            className="group relative flex flex-col justify-between p-12 transition-colors hover:bg-white/[0.02] lg:p-16"
          >
            {/* Quote icon */}
            <div
              className="mb-10 flex h-12 w-12 items-center justify-center border border-white/10"
              style={{ color: t.color }}
            >
