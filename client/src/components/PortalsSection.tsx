      ...
      <div className="max-w-[100rem] mx-auto px-8 py-20 lg:px-16 lg:py-28">
        <div className="flex flex-col gap-12 md:flex-row md:items-end md:justify-between">
          <div className="max-w-3xl">
            ...
            <h2 className="font-display text-5xl font-black italic leading-[0.85] text-[--ink] md:text-7xl lg:text-8xl">
              Soberania
              <br />
              Estratégica.
            </h2>
          </div>
          <p className="max-w-md font-body text-lg leading-relaxed text-[--ink]/48 lg:text-xl">
            Onde a criatividade acadêmica encontra a infraestrutura do capital
            para regenerar biomas e setores.
          </p>
        </div>
      </div>

      {/* Portal cards grid */}
      <div className="grid grid-cols-1 border-l border-t border-black/8 md:grid-cols-3">
        {portals.map(portal => (
          <motion.div
            key={portal.label}
            initial="initial"
            whileHover="hover"
            className="group relative h-[480px] w-full cursor-pointer overflow-hidden border-b border-r border-black/8 bg-white"
          >
            {/* Background image */}
            <div
              className="absolute inset-0 opacity-10 grayscale transition-all duration-1000 group-hover:scale-105 group-hover:opacity-24 group-hover:grayscale-0"
              style={{
            ...
            <div
              ...
              style={{
                background: `radial-gradient(circle at 50% 50%, ${portal.accentColor}, transparent)`,
              }}
            />
            ...
            >
              ...
              <div className="flex items-start justify-between">
                ...
                <div className="relative flex h-14 w-14 items-center justify-center overflow-hidden border border-black/8 bg-white/90 transition-all duration-500">
                  <div
                    className="absolute inset-0 opacity-0 transition-opacity group-hover:opacity-100"
                    style={{ backgroundColor: portal.accentColor }}
                  />
                  <ArrowUpRight className="relative z-10 h-6 w-6 text-[--ink] transition-all duration-500 group-hover:rotate-45 group-hover:text-black" />
                </div>
              </div>
              ...
              <div>
                ...
                <div
                  ...
                  style={{ backgroundColor: portal.accentColor }}
                />
                <p className="max-w-[90%] font-body text-base leading-relaxed text-[--ink]/54 transition-colors duration-500 group-hover:text-[--ink] md:text-lg">
                  {portal.description}
                </p>
              </div>
            </Link>
