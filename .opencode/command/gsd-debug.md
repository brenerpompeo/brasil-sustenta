...
```bash
debugger_model=$(node "/Users/brenerpompeorodrigues/Library/CloudStorage/GoogleDrive-brenerpompeo@gmail.com/Meu Drive/Vault:second_brain/second_brain/Projetos/brasil-sustenta/.opencode/get-shit-done/bin/gsd-tools.cjs" resolve-model gsd-debugger --raw)
```
